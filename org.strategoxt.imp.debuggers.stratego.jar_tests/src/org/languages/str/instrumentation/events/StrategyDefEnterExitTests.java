...
public class StrategyDefEnterExitTests extends EventInstrumentationBase {
	...
	public void setupProgram() throws ParseError, IOException {
		initHI();
		loadDSLDI(StrTestConstants.STR_SCRIPTS_DIR + "/dsldis/StrategyDefEnterExit.dsldi");
	...
	@Test
	public void instrumentStrategyDef() {
		sourceDSLLocation = StrTestConstants.STR_SCRIPTS_TESTCASES_DIR + "/fragments/fargs/strategydef.str";
		cleanupGenerated();
